const team_model = require("../models/teamModel.js")
const { get_path, set_path } = require("../utils.js")

module.exports.create_team = ({team_data_path = "team_data", user_id_path = "user_id", output_team_data_path = "team_data"} = {}) => {
    return (req, res, next) => {
...
module.exports.check_access_by_user_id_and_role = ({team_id_path = "team_id", user_id_path = "user_id", role = []} = {}) => {
    return (req, res, next) => {
        ...
        team_model.check_access_by_user_id_and_role({ team_id, user_id, role }, (error, results) => {
            if (error) {

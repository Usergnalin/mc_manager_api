...
module.exports.generate_token_cookie = ({id_path = "user_id"} = {}) => {
    return (req, res, next) => {
...
module.exports.generate_token = ({id_path = "agent_id"} = {}) => {
    return (req, res, next) => {
        const id = get_path(res, id_path)
        if (id === undefined) {
            console.error("No data found at path(s):", id_path)
...
module.exports.verify_token = ({id_path = "user_id"} = {}) => {
    return (req, res, next) => {
...
module.exports.delete_token_cookie = () => {
    return (req, res, next) => {
